                    ...
                    Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                border: Border.all(color: ColorConstant
                                    .colorEBE9F1),
                                borderRadius:
                        ...
                        Container(
                            decoration: BoxDecoration(
                                border: Border.all(
                                    color: ColorConstant.colorEBE9F1),
                                borderRadius:
                                const BorderRadius.all(Radius.circular(6))),
                            child: const Image(
                              width: 68,
                          ...
                          children: <TextSpan>[
                            TextSpan(
                                ...
                                recognizer: TapGestureRecognizer()
                                  ..onTap =
                                      () =>
                                      Util.navigateTo(context, const Signup())),
                          ],
                        ),
                      ),
                    ),
...
checkForUserLoggedIn(context) async {
  if (isUserLoggedIn()) {
    Util.navigateAndReplace(
        context as BuildContext, const HomeScreen());
  } else {
    SharedPreferences pref = await SharedPreferences.getInstance();
    googleSignOut(() =>
    {
